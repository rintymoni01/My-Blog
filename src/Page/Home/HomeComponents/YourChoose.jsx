...
return ( <div className="bg-gray-100 pt-4">
  ...
  {/* Title + Categories */}
  <div className="flex flex-col lg:flex-row justify-between items-center pt-8 container mx-auto px-4 gap-5 lg:gap-0">
